...
sudo apt-get install build-essential cmake vim python-dev python3-dev zsh git tmux autojump emacs ctags g++ clang aria2 axel openssh-server openssh-client mysql-server mysql-client texlive-full fontforge latex-cjk-chinese pandoc python-autopep8
