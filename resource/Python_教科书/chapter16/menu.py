...
menubar.add_cascade(label='File', menu=menufile) #把菜单menufile作为层叠菜单添加到主菜单栏menubar
menubar.add_cascade(label="Edit", menu=menuedit)
menubar.add_cascade(label="Help", menu=menuhelp)
menubar.add_cascade(label="菜单2", menu=menuTest)
#添加菜单项
menufile.add_command(label='Open')     #在菜单menufile中添加菜单项Open
...
menuhelp.add_command(label="About")   #在菜单menuhelp中添加菜单项About
menuTest.add_command(label="菜单项1")#在菜单menuTest中添加菜单项1
...
menuTest.add_cascade(label="子菜单", menu=menusub)#把菜单menusub作为层叠菜单添加到菜单menuTest
